  ...
  return (
    <div className="space-y-4 pb-4">
      <header className="pb-1">
        <h1 className="text-[20px] font-bold tracking-tight text-zinc-900">Dịch nhanh</h1>
        <p className="text-[13px] text-zinc-500 mt-1">Tuỳ chỉnh tab dịch trực tiếp trong popup.</p>
      ...
      <section className="surface-card surface-card-hover p-4 space-y-3 transition-all duration-200">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-[13px] font-semibold tracking-tight text-zinc-900">Hành vi</h2>
        </div>
